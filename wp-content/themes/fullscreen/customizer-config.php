...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'main_nav_button' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Menu Button', 'themify' ),
			),
			'selector' => '#menu-button',
			'prop' => 'background',
		),
		
		'main_nav_button_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Menu Button Font', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#menu-button',
			'prop' => 'font',
		...
		'main_nav_button_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Menu Button Color', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#menu-button',
			'prop' => 'color',
		...
		'main_nav_button_hover' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Menu Button Hover', 'themify' ),
			),
			'selector' => '#menu-button:hover',
			'prop' => 'background',
		),

		'main_nav_button_color_hover' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Menu Button Color Hover', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#menu-button:hover',
			'prop' => 'color',
		...
		// Accordion Start ---------------------------
		'start_welcome_text_acc' => $themify_customizer->accordion_start( __( 'Welcome Text', 'themify' ) ),
		
		'welcome_text_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Welcome Message', 'themify' ),
			),
			'selector' => '.welcome-message',
			'prop' => 'font',
		),
		'welcome_text_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Welcome Message', 'themify' ),
				'show_label' => false,
		...
		'welcome_heading1_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Heading 1 Font', 'themify' ),
			),
			'selector' => '.welcome-message h1',
			'prop' => 'font',
		),
		'welcome_heading1_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Heading 1 Color', 'themify' ),
				'show_label' => false,
		...
		'welcome_heading2_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Heading 2 Font', 'themify' ),
			),
			'selector' => '.welcome-message h2',
			'prop' => 'font',
		),
		'welcome_heading2_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Heading 2 Color', 'themify' ),
				'show_label' => false,
		...
		'welcome_heading3_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Heading 3 Font', 'themify' ),
			),
			'selector' => '.welcome-message h3',
			'prop' => 'font',
		),
		'welcome_heading3_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Heading 3 Color', 'themify' ),
				'show_label' => false,
		...
		'welcome_heading4_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Heading 4 Font', 'themify' ),
			),
			'selector' => '.welcome-message h4',
			'prop' => 'font',
		),
		'welcome_heading4_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Heading 4 Color', 'themify' ),
				'show_label' => false,
		...
		'welcome_heading5_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Heading 5 Font', 'themify' ),
			),
			'selector' => '.welcome-message h5',
			'prop' => 'font',
		),
		'welcome_heading5_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Heading 5 Color', 'themify' ),
				'show_label' => false,
		...
		'welcome_heading6_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Heading 6 Font', 'themify' ),
			),
			'selector' => '.welcome-message h6',
			'prop' => 'font',
		),
		'welcome_heading6_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Heading 6 Color', 'themify' ),
				'show_label' => false,
		...
		'welcome_link_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Welcome Message Link', 'themify' ),
			),
			'selector' => '.welcome-message a',
			'prop' => 'color',
		),

		'welcome_link_font' => array(
			'control' => array(
				'type'    => 'Themify_Text_Decoration_Control',
			),
			'selector' => '.welcome-message a',
		...
		'welcome_link_hover_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Welcome Message Link Hover', 'themify' ),
			),
			'selector' => '.welcome-message a:hover',
			'prop' => 'color',
		),

		'welcome_link_hover_font' => array(
			'control' => array(
				'type'    => 'Themify_Text_Decoration_Control',
			),
			'selector' => '.welcome-message a:hover',
		...
		'end_welcome_text_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------
